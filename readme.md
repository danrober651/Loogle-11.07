...
2: upload the '/theme/loogle_11_07/' folder to '/wp-content/themes/' directory in your web server.

3: Log in to the WordPress Administration Dashboard

4: Select the 'Themes' sub-menu from 'Appearance' menu

5: Select the 'Loogle_11_07' theme from the available list of themes to preview
