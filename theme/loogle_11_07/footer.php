...
*/?>
   <div id="footer">
		...
		<p>Copyright &copy; <?php echo date('Y'); ?> <a href="<?php bloginfo('url') ?>"><?php bloginfo('name'); ?></a> all rights reserved.	Powered by  <a href="http://wordpress.org/" titl="Powered by WordPress">WordPress</a>. Theme by<a href="http://www.lineshjose.com/"> Linesh Jose</a></p>
    </div>
</div>
